define(['modules/backbone-mozu', 'modules/api', 'underscore', 'modules/models-address', 'modules/models-orders', 'modules/models-paymentmethods', 'modules/models-product', 'hyprlive'], function (Backbone, api, _, AddressModels, OrderModels, PaymentMethods, ProductModels, Hypr) {
    ...
    Customer = Backbone.MozuModel.extend({
        mozuType: 'customer',
        helpers: ['hasSavedCards', 'hasSavedContacts', 'segmentMap'],
        ...
        segmentMap: function() {
            return api.get('entity',{ listName:'SegmentProductMap@mzint'}).then(function(resp) {
                return resp;
            });
        },
        relations: {
